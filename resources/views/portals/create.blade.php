...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('dashboard') }}" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-lg font-medium">
                Back to Dashboard
            </a>
        </div>
    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('portals.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3" 
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" 
                                placeholder="Describe your portal's purpose...">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex items-center space-x-3">
                                    <input type="color" name="secondary_color" id="secondary_color" value="{{ old('secondary_color', '#1F2937') }}" 
                                        class="h-10 w-20 border border-gray-300 rounded-md cursor-pointer">
                                    <input type="text" value="{{ old('secondary_color', '#1F2937') }}" 
                                        class="flex-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" 
                                        readonly>
                                </div>
                            ...
                            <div class="bg-gray-50 rounded-lg p-6" id="portal-preview">
                                <div class="flex items-center space-x-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600" id="preview-description">Portal description will appear here</p>
                                    </div>
                                </div>
                                <div class="grid grid-cols-3 gap-4">
                                    <div class="bg-white p-3 rounded-lg shadow-sm">
                                        <div class="w-8 h-8 rounded-full mb-2" style="background-color: var(--primary-color, #3B82F6)"></div>
                                        <p class="text-sm font-medium text-gray-900">Projects</p>
                                    </div>
                                    <div class="bg-white p-3 rounded-lg shadow-sm">
                                        <div class="w-8 h-8 rounded-full mb-2" style="background-color: var(--secondary-color, #1F2937)"></div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updatePreview() {
                ...
                const description = descriptionInput.value || 'Portal description will appear here';
